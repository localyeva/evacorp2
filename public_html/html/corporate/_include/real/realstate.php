...
<div class="container center realastate-3">    
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-dm-12 col-lg-12 text-pos">         
            <img src="img/realestate/3.png" class="img-responsive center-block">           
        </div>
        <div class="col-xs-12 col-sm-12 col-dm-12 col-lg-12 text-pos">         
            <img src="img/realestate/4.png" class="img-responsive center-block">           
        </div>
        <div class="col-xs-12 col-sm-12 col-dm-12 col-lg-12 text-pos">         
            <img src="img/realestate/5.png" class="img-responsive center-block">           
        </div>                
    </div>    
</div>
...
<div class="container center realastate-6">
    <div class="row text-center">
        <div class="col-xs-12 col-sm-12 col-dm-12 col-lg-12">
            <p>1.サイト入力</p>
            <img src="img/realestate/8.png" class="img-responsive center-block">
            <p>2.サイトへの入力+掲載確認</p>
            <img src="img/realestate/9.png" class="img-responsive center-block">
            <p>3.空室確認+サイト更新</p>
            <img src="img/realestate/10.png" class="img-responsive center-block">                        
        </div>
    </div>
</div>
...
<div class="realastate-7">
    <div class="container center realastate-7-1">
        <div class="row" style="max-width:800px;margin:auto;">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <img src="img/realestate/12.png" class="img-responsive center-block realastate-7-1-1">
            </div>
        </div>
    </div>
</div>
