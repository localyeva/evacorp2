...
get_header();
?>
<div class="container voice-senpai-content">
    <div class="row voice-senpai-content-1 center">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="voice-senpai-content-1-title">
                <div class="voice-senpai-content-1-title-row">
                    <div class="voice-senpai-content-1-title-cell">
                        <span>先輩社員の声</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 left">
            ...
            <div class="voice-senpai-content-2-table">
                ...
                <div class="voice-senpai-content-2-row">
                    ...
                    <div class="voice-senpai-content-2-cell-2">
                        （前職）ペガジャパン株式会社<br/>（前々職）CA Technology
                    </div>
                </div>
                <div class="voice-senpai-content-2-row">
                    <div class="voice-senpai-content-2-cell-1">
            ...
            <p>
                ベトナムに視察に来られたお客様のフォローをしています。日本法人の営業各位と協力してアカウントプラン作成、実行、提案書作成することも重要な仕事です。
            </p>
            <p class="voice-senpai-content-2-question">
                <img src="<?php echo get_template_directory_uri() ?>/img/voice/h3_bg_q.png" width="29" height="29">
            ...
            <p>
                何よりベトナムで働きたかったため、「ベトナム」「IT系」「現地法人採用」「自主独立」が当てはまるを企業を探していました。エボラブルアジアはこれらを備えている上に、ラボ型はまだまだ市場を拡大できるソリューションだと実感したためです。
            </p>
            <p class="voice-senpai-content-2-question">
                <img src="<?php echo get_template_directory_uri() ?>/img/voice/h3_bg_q.png" width="29" height="29">
            ...
            <p>
                エボラブルアジアのスタッフが成長し成果を出し、その結果お客様が成功し、それが自社の成長に繋がる好循環が目の前で起きています。海外で成功体験を持つことは、何者にも代え難い経験と知識を持つことができます。
            </p>
            <p class="voice-senpai-content-2-question">
                <img src="<?php echo get_template_directory_uri() ?>/img/voice/h3_bg_q.png" width="29" height="29">
            ...
            <p>
                経済が伸び、その背景に若い人達の能力と努力があります。また、努力の結果がきっと成功につながる国です。こんな場所は他にあるでしょうか？
            </p>
            <p class="voice-senpai-content-2-question">
                <img src="<?php echo get_template_directory_uri() ?>/img/voice/h3_bg_q.png" width="29" height="29">
            ...
            <p>
                高度成長期の国で働きましょう。今日より明日がいい日、明日より明後日がいい日。そんな気分になれる国です。
            </p>
        </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 left">
            ...
            <div class="voice-senpai-content-2-table">
                ...
                <div class="voice-senpai-content-2-row">
                    ...
                    <div class="voice-senpai-content-2-cell-2">
                        ㈱リクルートで広告の営業をしていました。<br/>IT業界はまったくの未経験です。
                    </div>
                </div>
                <div class="voice-senpai-content-2-row">
                    <div class="voice-senpai-content-2-cell-1">
            ...
            <p>
                ラボマネージャーです。 メンバーに対しては、彼らが前向きに活き活きと働くことができる環境をソフト、ハードともに提供すること。お客様に対しては、メンバーとともにお客様の事業に貢献することです。 <br/>
                と書くとすごく堅い仕事のようですが、実際は毎日メンバーやお客様と楽しくお話させてもらって、その中からお困りのことはないか、こんなことできたらメンバーは喜ぶかなぁ等を考えてご提案することが日々のお仕事です。
            </p>
            <p class="voice-senpai-content-2-question">
                <img src="<?php echo get_template_directory_uri() ?>/img/voice/h3_bg_q.png" width="29" height="29">
                <span>エボラブルアジアに入社しようと思ったきっかけを教えてください。</span>
            ...
            <p>
                日本では得がたい経験ができると思ったので。これまでの営業経験や考え方等、すべてを使える（使わなければいけない）仕事だと思ったので。
            </p>
            <p class="voice-senpai-content-2-question">
                <img src="<?php echo get_template_directory_uri() ?>/img/voice/h3_bg_q.png" width="29" height="29">
                <span>エボラブルアジアで働く楽しさを教えてください。</span>
            ...
            <p>
                ベンチャーならではの大変さをお客様も含め最愛の仲間たちとなら乗り越えられる！と信じて働けているところ。
            </p>
            <p class="voice-senpai-content-2-question">
                <img src="<?php echo get_template_directory_uri() ?>/img/voice/h3_bg_q.png" width="29" height="29">
                <span>ベトナムで働く楽しさを教えてください。</span>
            ...
            <p>
                ベトナム人の勤勉さやピュアな心に触れられるところ。エボラブルアジアの入社を期に初めてベトナムに来ましたが、日本人には非常に馴染みやすい国だと思います。アジアンフードが苦手でしたが、ベトナムのご飯は本当に美味しいと思います。
            </p>
            <p class="voice-senpai-content-2-question">
                <img src="<?php echo get_template_directory_uri() ?>/img/voice/h3_bg_q.png" width="29" height="29">
                <span>未来に一緒に働く方達へ一言お願いします。</span>
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 left">
            ...
            <div class="voice-senpai-content-2-table">
                ...
                <div class="voice-senpai-content-2-row">
                    ...
                    <div class="voice-senpai-content-2-cell-2 last">
                        教会の前の公園に座ってコーヒーを飲んだり、<br/>日本語クラブに参加して、日本語を教えたりしています。
                    </div>
                </div>
            </div>
            <p class="voice-senpai-content-2-question">
...
一緒にベトナム、エボラブルアジアをさらに盛り上げませんか？
    ...
    <div class="row voice-senpai-content-2 center" id="anchor08">
        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
...
また、フェイスブックやブログからも日々発信を続けています。
    ...
    <div class="row voice-senpai-content-2 center" id="anchor09">
        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
