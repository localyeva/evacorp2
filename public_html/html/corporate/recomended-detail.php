...
<html>
    ...
    <body>
        ...
        <div id="recomended">
            <?php include('./_include/recomended-detail/banner.php'); ?>
            <?php include('./_include/recomended-detail/breadcrumbs.php'); ?>
            <div class="container-fluid center bpo-1">
                <?php include('./_include/recomended-detail/content.php'); ?>
            </div>
