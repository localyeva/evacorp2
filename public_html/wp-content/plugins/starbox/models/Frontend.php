        ...
        if (isset($this->author) && isset($this->author->ID)) {
            ...
            $content .= '
                         <div class="abh_box abh_box_' . $this->position . ' abh_box_' . $this->details['abh_theme'] . '">
                                <ul class="abh_tabs">
                                 <li class="abh_about abh_active"><a href="#abh_about">' . __('この記事を書いた人', _ABH_PLUGIN_NAME_) . '</a></li>
                                 <li class="abh_posts"><a href="#abh_posts">' . __('最近の記事', _ABH_PLUGIN_NAME_) . '</a></li>
                                </ul>
                                <div class="abh_tab_content">' .
                    $this->showAuthorDescription() .
                    $this->showAuthorPosts() . '
                                ' . ((ABH_Classes_Tools::getOption('abh_powered_by') == 1) ? '<div class="abh_pwb"><a href="http://wordpress.org/plugins/starbox/" target="_blank" title="Starbox - Author Box" rel="nofollow">' . __('', _ABH_PLUGIN_NAME_) . '</a></div>' : '') . '
                                </div>
                         </div>';
