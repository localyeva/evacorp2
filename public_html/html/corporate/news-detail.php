...
<html>
    ...
    <body>
        ...
        <div id="news">
            <?php include('./_include/news-detail/banner.php'); ?>
            <?php include('./_include/news-detail/breadcrumbs.php'); ?>
            <div class="container center bpo-1">
                <?php include('./_include/news-detail/sidebar.php'); ?>
                <?php include('./_include/news-detail/content.php'); ?>
            </div>
