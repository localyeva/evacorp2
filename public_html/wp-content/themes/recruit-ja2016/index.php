...
?>
        ...
        <div class="container index-content">
            <div class="row title-cruit  hidden-xs">
            ...
            <div class="row category-cruit">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 center category-cruit-item">
                    <a href="<?php echo bloginfo('url') ?>/voice/senpai#anchor01">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 center category-cruit-item">
                    <a href="<?php echo bloginfo('url') ?>/voice/senpai#anchor05">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 center category-cruit-item">
                    <a href="<?php echo bloginfo('url') ?>/voice/senpai#anchor04">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 center category-cruit-item">     
                    <a href="<?php echo bloginfo('url') ?>/voice/senpai#anchor02">
