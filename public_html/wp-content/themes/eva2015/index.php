        ...
        <div class="row">
            <div class="container">
                ...
                <div class="col-md-8 hidden-xs why-text-right">
                    ...
                    <div class="text-small">2012年の設立以降、今では東南アジア地域で日系最大規模のラボ型オフショア開発企業としてさらに成長を続けるEVOLABLE ASIA CO., LTD。その成長の背景には、「高品質な人材の提供」と「安心のサポートシステム」があります。EVOLABLE ASIA CO., LTDでは質が高く幅広い技術者を豊富に確保し、最適な環境で就業してもらえるノウハウと実績を持っています。また日本人ラボマネージャーが常駐し、初めてベトナム進出する企業も、より安心して業務をスタートできるようなサポートシステムが整っています。詳しくはこちらのページをご覧ください。
                    </div>
                    <div class="">
