...
/*
 * Author: KhangLe
 * Template Name: Offshore Development
 * 
 */
get_header();
?>
<div id="labo">
                ...
                <div class="container custom-containter">
                    <div class="row">
                        <div class="col-xs-12 col-md-12 text-center">
                            ...
                            <div class="row-gap-small"></div>
                            <h4>
                                日本からプロジェクトマネージャーを1名選出し、
                            </h4>
                            <br/>
                            <h4>
                                ベトナムでベトナム人スタッフとチームを組み開発を行っていく開発形態です。
                            </h4>
                        </div>
                    </div>
                    <div class="row-gap-big"></div>
                        ...
                        <div class="row">
                            <div class="col-xs-4 col-md-4 no-padding-lr">
                                <article>
                                    ...
                                    <div class="title text-center">
                                        ...
                                        <h5>クライアント企業が選出した<br><br>日本人スタッフ</h5>
                                    </div>
                                </article>
                            </div>
                            ...
                            <div class="col-xs-4 col-md-4 no-padding-lr">
                                <article>
                                    ...
                                    <div class="title text-center">
                                        <h4>ラボマネージャー</h4><br>
                                        <h5>円滑なプロジェクトに関する窓口<br><br>(相談/定期面談受付)</h5>                                    
                                    </div>
                                </article>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6 item">
                                ...
                                <div>
                                    ...
                                    <ul>
                                        <li>渡航前後サポートサービス</li>
                                        <li>ビザ更新・住居等に関するサポートサービス</li>
                                        <li>各種事務処理サポートサービス</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6 item">
                                ...
                                <div>
                                    ...
                                    <ul>
                                        <li>ニーズにマッチした人材採用(大手人材会社との提携)</li>
                                        <li>開発チーム調整サポート</li>
                                        <li>ベトナム人エンジニアに対する定期面談</li>
                                    </ul>
                                </div>
                            </div>
                        </div>      
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-10 col-md-offset-1">
                    <div class="row">
                        <div class="col-md-6 rect">
                            <h4><i class="fa fa-minus"></i>給与の支払いや社会保険などの労務も行います</h4>
                        </div>     
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-10 col-md-offset-1">
                    <div class="row">
                        <div class="col-md-6 rect">
                            <h4><i class="fa fa-minus"></i>ベトナム人スタッフの社員教育も行います。</h4>
                        </div>     
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid last-block">
        <div class="container">
            <div class="row-gap-big"></div>
            <div class="row">
                <div class="col-xs-12 col-md-12">
